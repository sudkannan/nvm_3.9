...
#define __NR_nv_mmap_pgoff (__X32_SYSCALL_BIT + 314)
#define __NR_nvpoolcreate (__X32_SYSCALL_BIT + 315)
#define __NR_NValloc (__X32_SYSCALL_BIT + 316)
#define __NR_move_inactpages (__X32_SYSCALL_BIT + 317)
