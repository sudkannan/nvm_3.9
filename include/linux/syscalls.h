...
//NVM Changes
asmlinkage long sys_NValloc( unsigned long length );
asmlinkage long sys_nvpoolcreate( unsigned long num_pool_pages );
asmlinkage long sys_nv_mmap_pgoff(
                unsigned long addr, unsigned long len,
                unsigned long prot, unsigned long flags,
                struct nvmap_arg_struct __user  *nvarg);

asmlinkage long sys_initpmem(unsigned long inode);
asmlinkage long sys_nv_commit(
                        unsigned long addr, unsigned long len,
                        struct nvmap_arg_struct __user *nvarg);
