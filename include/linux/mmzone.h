...
enum zone_stat_item {
	...
	NR_FREE_CMA_PAGES,
        NR_NVM_PERSIST_PAGES,
        NR_NVM_NONPERSIST_PAGES,
...
enum lru_list {
	...
	LRU_UNEVICTABLE,
#ifdef CONFIG_NVM_1
	 LRU_INACTIVE_NVMANON = LRU_BASE + LRU_NVM,
	 LRU_ACTIVE_NVMANON = LRU_BASE + LRU_NVM + LRU_ACTIVE,
#endif
	NR_LRU_LISTS
};
...
typedef struct pglist_data {
    ...
    //NVRAM changes
    /*indicates if the node is a persistent memory*/
    int pmem_node;
    //NVRAM changes  
